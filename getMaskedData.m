...
%data - a 3 dimensional matrix of data that is trial x time x variable
%dataMask - can be either 0/1 with the 1 data points pulled out, or
%           integers specifying the original trial number in data
%trialNum - (optional) array of the original trial numbers to pull out
%nanReversePadding - (optional) if true put NaN padding at the beginning of
%           trials rather than the end for trials of unequal length
